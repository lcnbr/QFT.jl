...
Base.isless(::AbstractField,::AbstractField) = false
...
function feynmanRule(::MIME"text/FORM",(p#=Momentum=#,f)::Tuple{Any,AbstractField})
  return ""
end
function feynmanRule(::MIME"text/FORM",::Vararg{Tuple{Any,AbstractField},N}) where {N}
  return ""
end

function feynmanRule(m::MIME"text/FORM",(p1,f1)::Tuple{Any,AbstractField},(p2,f2)::Tuple{Any,AbstractField})
  @assert p1==p2
  return feynmanRule(m,p1,f1,f2)
end

function feynmanRule(m::MIME"text/FORM",p1,f1::AbstractField,f2::AbstractField)
  return feynmanPropagator(m,p1,mass(f1))
end

function feynmanPropagator(MIME::MIME"text/FORM",momentum,mass)
  if mass===:none
...
function feynmanRule(::MIME,::Vararg{Tuple{Any,AbstractField},N}) where {N}
  return 1
end
